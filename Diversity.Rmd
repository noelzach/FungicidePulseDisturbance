...
adonis2(bacteria.norm.leaf.soy.bray~Fungicide*Treatment*GrowthStage, as(sample_data(bacteria.norm.leaf.soy), "data.frame")) 
...
adonis2(fungi.norm.leaf.soy.bray~Fungicide*Treatment*GrowthStage, as(sample_data(fungi.norm.leaves.soy), "data.frame"))
...
adonis2(fungi.norm.root.soy.bray~Fungicide*Treatment*GrowthStage, as(sample_data(fungi.norm.root.soy), "data.frame"))
...
adonis2(fungi.norm.root.corn.bray~Fungicide*Treatment*GrowthStage, as(sample_data(fungi.norm.root.corn), "data.frame"))
