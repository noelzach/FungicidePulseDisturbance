...
```{r FUNGI UNEDITED}
# Save an object to a file
saveRDS(fungi_obj2, file = "Preprocessing/Fungicide_Fungi_RootsAndLeaves_obj2_unedited_022221.rds")
# Restore the object
fungi.obj2.unedited <- readRDS(file = "Preprocessing/Fungicide_Fungi_RootsAndLeaves_obj2_unedited_022221.rds")
```
...
```{r FUNGI No Norm - RDS}
# Save an object to a file
saveRDS(fungi_obj2_1000reads, file = "Preprocessing/Fungicide_Fungi_RootsAndLeaves_1000readsmin_nonorm_022221.rds")
# Restore the object
fungi.no.norm <- readRDS(file = "Preprocessing/Fungicide_Fungi_RootsAndLeaves_1000readsmin_nonorm_022221.rds")
```
...
# Save an object to a file
saveRDS(fungi.css.norm, file = "Preprocessing/Fungicide_Fungi_RootsAndLeaves_1000seqMin_CSSNorm_022221.rds")
# Restore the object
fungi.css.norm <- readRDS(file = "Preprocessing/Fungicide_Fungi_RootsAndLeaves_1000seqMin_CSSNorm_022221.rds")
```
